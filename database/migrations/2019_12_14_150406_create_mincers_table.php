...
class CreateMincersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mincers', function (Blueprint $table) {
            ...
            $table->string('rever')->nullable();
            $table->string('power')->nullable();
            $table->string('antiheating')->nullable();
            $table->string('cablebox')->nullable();
            $table->string('headersbox')->nullable();
            $table->string('rubberleg')->nullable();
