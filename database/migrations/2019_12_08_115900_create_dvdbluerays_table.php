...
class CreateDvdblueraysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dvdbluerays', function (Blueprint $table) {
            ...
            $table->string('dts')->nullable();
            $table->string('dolbydigital')->nullable();
    ...
    {
        Schema::dropIfExists('dvdbluerays');
    }
}
