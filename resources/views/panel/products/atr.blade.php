...
<div class="types_nav">
    ...
    <div class="form-add">
        ...
        <form action="{{ route('addAtr') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
              <label for="exampleFormControlInput1">Atr</label>
              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="atr" >
            </div>
